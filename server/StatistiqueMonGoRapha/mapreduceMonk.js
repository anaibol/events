...
//var db = mongojs(, ['events','LiveParVilles_results']);
var db = require('monk')(global.config.db);
var Events = db.get('events');
var LiveParVilles_results = db.get('liveParVilles_results');
...
Events.find({$or: [{ start_time: {$gt: Dateminuit }}, {end_time: {$gt: Dateminuit }}]},
        function(err, docs) {
...
//la map Reuce sur events
    ...
    LiveParVilles_results.find(function (err, docs) {
