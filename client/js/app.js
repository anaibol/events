var app = angular.module('wooepa', ['wooepa-templates', 'geolocation', 'ngStorage', 'querystring', 'ui.router', 'ui.bootstrap','ezfb', 'truncate', 'ngSanitize', 'angular-data.DSCacheFactory', 'angularMoment', 'gettext', 'infinite-scroll', 'headroom', 'ngAnimate']); //'imageupload', , 'seo' 'leaflet-directive'
