...
parser = OptionParser();
parser.add_option("-f", "--filename", action="store", dest="filename", default="", help=" where to read the data ");
parser.add_option("-v", "--verbose",  action="store_true", dest="verbose", default=0, help="To display more information ");
parser.add_option("-l", "--limit", action="store", dest="limit", default=0, help="To display more information ");
